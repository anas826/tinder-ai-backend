...
* The original package name 'com.tinder.tinder-ai-backend' is invalid and this project uses 'com.tinder.tinder_ai_backend' instead.
...
* [Docker Compose Support](https://docs.spring.io/spring-boot/docs/3.2.8/reference/htmlsingle/index.html#features.docker-compose)
